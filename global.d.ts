...
declare namespace SV {
   ...
   * @param group
   */
  function getPhonemesForGroup(group: NoteGroupReference): Array<string>;
   ...
   * @param callback
   */
  function showInputBoxAsync(title: string, message: string, defaultText: string, callback: (answer: string) => void): void;
...
interface VoiceAttributes {
   ...
   */
  alt: Array<number>; // TODO: Really number?
}
